                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        ...
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faNode} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faGithub} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faCodeBranch} /></span>
                                    ...
                                    <button type="button" class="btn btn-outline-secondary">Pleno</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        ...
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faPalette} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faMobileScreen} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faBrush} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faDesktop} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faCompassDrafting} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faPenRuler} /></span>
                                    </p>
                                    <button type="button" class="btn btn-outline-secondary">Senior</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row g-0">
                            ...
                            <div className="col-md-8">
                                <div className="card-body">
                                    ...
                                    <p className="card-text">
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faShieldHalved} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faCloud} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faUbuntu} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faWindows} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faDebian} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faCpanel} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faServer} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faLinux} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faDatabase} /></span>
                                        <span className="text-Light fs-4 mx-1"><FontAwesomeIcon icon={faNetworkWired} /></span>
                                    </p>
                                    <button type="button" class="btn btn-outline-secondary">Senior</button>
                                </div>
                            </div>
